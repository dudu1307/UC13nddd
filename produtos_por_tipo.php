...
$rowPorTipo = $listaPorTipo->fetch_assoc(); // $rows = $listaPorTipo->fetch_all(); - Mais linhas
...
<body class="fundofixo">
    ...
    <!-- Mostrar os registros se a consulta SE retornar VAZIO -->
    <?php if($numRows==0){?>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="thumbnail">
                        <a href="produto_detalhe.php?id_produto=<?php echo $rowPorTipo['id_produto'];?>">
                            <img src="images/<?php echo $rowPorTipo['imagem_produto'];?>"
                            class="img-responsive img-rounded"
                            style="height:20em;">
                        </a>
                        <div class="caption text-rigth">
